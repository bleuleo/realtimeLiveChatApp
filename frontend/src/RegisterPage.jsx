    ...
    <div className="login-page">
      <div className="card">
        ...
        <form onSubmit={onSignup}>
          ...
          {/* Show the signup error message */}
          {usernameTakenError && (
            <div className="error">{usernameTakenError}</div>
          )}{" "}
          {/* Show the username taken error message */}
          <input
            type="text"
            name="username"
            placeholder="Username*"
          ...
          {signupFirstNameError && (
            <div className="error">{signupFirstNameError}</div>
          )}
          <input
            type="text"
            name="first_name"
      ...
      <style>{`
      .login-page { width: 100vw; height: 100vh; padding-top: 6vw; background: linear-gradient(180deg, #5d467c 7%, #b18ae4 17%, #786dbb 29%, rgba(99,103,174,1) 44%, #496cbe 66%, rgba(70,135,198,1) 83%, rgba(44,163,219,1) 96%, rgba(22,188,237,1) 100%, rgba(0,212,255,1) 100%); }
